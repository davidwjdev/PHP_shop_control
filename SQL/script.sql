...
CREATE TABLE `shop_control`.`pedidos` ( `id_pedido` INT NOT NULL AUTO_INCREMENT , `data` DATE NOT NULL , `codigo_barras` BIGINT(48) NOT NULL , `id_produto` INT NOT NULL , `quantidade_produto` INT NOT NULL , `id_cliente` INT NOT NULL , PRIMARY KEY (`id_pedido`));
...
ALTER TABLE `pedidos` ADD CONSTRAINT `fk_pedido_produto` FOREIGN KEY (`id_produto`) REFERENCES `produtos`(`id_produto`) ON DELETE RESTRICT ON UPDATE RESTRICT;